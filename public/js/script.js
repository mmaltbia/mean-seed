$(document).ready(function() {
    ...
    circleBtn.on('click', function(){
        ...
        console.log('rectangle class removed');
        lineBtn.removeClass();
        textBtn.removeClass();
        toggleShape();
    })
    ...
    var divId = $('#div-' + i);
    var containsId = $.contains(divId, document.body);
    var width;
    var height;
            ...
            jQuery(function($) {
                ...
                canvas.selectable({ 
                            ...
                            start: function(e) {
                                    ...
                                    x_begin = e.pageX - parentOffset.left,
                                    y_begin = e.pageY - parentOffset.top;
                            ...
                            stop: function(e) {
                                    ...
                                    x_end = e.pageX - parentOffset.left,
                                    y_end = e.pageY - parentOffset.top;
            ...
            jQuery(function($) {
                ...
                var makeLine = function() {
                    canvas.on("mousedown", function(event){
                        ...
                        var x_begin = event.pageX - parentOffset.left;
                        var y_begin = event.pageY - parentOffset.top;

                    var endLine = function(event){
                        canvas.on("mouseup", function(event){
                        var x_end = event.pageX - parentOffset.left;
                        var y_end = event.pageY - parentOffset.top;
                        ...
                        canvas.append('<div class="line-endpoint"><svg height="' + height + '" width="'+ width +'"><line x1="' + x_begin + '" y1="' + y_begin + '" x2="' + x_end + '" y2="' + y_end + '" style="stroke:rgb(255,0,0);stroke-width:2" /></svg></div>')
                        $('.line-endpoint').css({
                            "position"  : "absolute",
                            "top"       : y_begin,
                            "left"      : x_begin,
                        ...
                        console.log('mousedown: ' + x_begin + ',' + y_begin);
                    });
                }
                makeLine();
                //make .container selectable and...
                canvas.selectable({ 
                            ...
                            stop: function(e) {
                                    ...
                                    //append a new div and increment the class and turn it into jquery selector
                                    // $(this).append('<div id="div-' + i + '" class="gen_line_' + i + '"><svg height="' + height + '" width="'+ width +'"><line x1="' + x_begin + '" y1="' + y_begin + '" x2="' + x_end + '" y2="' + y_end + '" style="stroke:rgb(255,0,0);stroke-width:2" /></svg></div>');
                                    gen_box = $('.gen_line_' + i);
                                    // div_id = $('#gen_line_' + i);
            ...
            jQuery(function($) {
                ...
                canvas.selectable({ 
                            ...
                            stop: function(e) {
                                    ...
                                    //append a new div and increment the class and turn it into jquery selector
                                    $(this).append('<div contenteditable="true" id="div-'+ i +'" class="gen_text_' + i + '"></div>');
                                    gen_box = $('.gen_text_' + i);
                                    text_box = $('.text-box-' + i);
                                    div_id = $('#gen_text_' + i);
                                    div_details = {'x': x_begin, 'y': y_begin, 'color': '#fff', 'stroke': '', 'width': width, 'height': height};
